...
CREATE TABLE `auth_challenges` (
  ...
  `lookup_token` varchar(128) DEFAULT NULL,
  ...
  KEY `idx_auth_challenges_type_status_expires` (`challenge_type`,`status`,`expires_at`),
...
VALUES
    ...
    ('email_verification_code_daily_limit', '0', NOW()),
    ('sms_verification_code_daily_limit', '0', NOW()),
