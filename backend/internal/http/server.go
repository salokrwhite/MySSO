...
func (s *Server) registerRoutes() {
	...
	api.POST("/auth/qr-login/challenges", s.handleCreateQRLoginChallenge)
	api.GET("/auth/qr-login/challenges/:challenge_token", s.handleGetQRLoginStatus)
	api.POST("/auth/qr-login/scan", s.requireSession(), s.handleScanQRLogin)
	api.POST("/auth/qr-login/confirm", s.requireSession(), s.handleConfirmQRLogin)
	...
	admin.POST("/apps", s.handleCreateAdminApp)
	...
	admin.POST("/apps/:id/reset-secret", s.handleResetAdminAppSecret)
	admin.POST("/apps/:id/disabled", s.handleSetAdminAppDisabled)
	admin.GET("/apps/:id/audit-logs", s.handleAppAuditLogs)
	admin.POST("/apps/:id/audit-logs/delete", s.handleDeleteAppAuditLogs)
