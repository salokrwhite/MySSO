const locale = {
  translation: {
    ...
    auth: {
      ...
      authorize: {
        ...
        errors: {
          ...
          applicationAccessBanned: "Dostęp do aplikacji jest zabroniony",
          applicationAccessBannedWithReason: "Dostęp do aplikacji jest zabroniony: {{reason}}",
          applicationNotApproved: "Aplikacja nie została zatwierdzona",
          applicationNotFound: "Aplikacja nie została znaleziona",
          forbidden: "Nie masz uprawnień dostępu do tej aplikacji",
          unsupportedResponseType: "Niedozwolony typ odpowiedzi",
          redirectUriMismatch: "Niezgodność URI przekierowania",
          scopeNotAllowed: "Żądana zakres uprawnień nie jest dozwolony",
          openidScopeRequired: "Wymagany zakres uprawnień openid",
          codeChallengeMethodRequiresCodeChallenge: "Podanie code_challenge_method wymaga code_challenge",
          unsupportedCodeChallengeMethod: "Niedozwolona metoda code challenge",
          promptNoneMustNotBeCombinedWithOtherValues: "Wartość none parametru prompt nie może być łączyć z innymi wartościami",
          invalidMaxAge: "Nieprawidłowa wartość max_age",
          acrValuesNotSatisfied: "Bieżąca sesja logowania nie spełnia wymagań kontekstu uwierzytelniania",
          consentRequired: "Wymagana dodatkowa zgoda",
          loginRequired: "Zaloguj się ponownie, aby kontynuować",
          authorizeFailed: "Uwierzytelnienie nie powiodło się. Spróbuj ponownie.",
          loadAuthorizationSettingsFailed: "Nie udało się załadować ustawień autoryzacji",
          networkRequestFailed: "Żądanie sieciowe nie powiodło się. Sprawdź połączenie i spróbuj ponownie.",
          apiReturnedHtml: "Usługa autoryzacji zwróciła nieoczekiwaną stronę. Sprawdź konfigurację API lub serwera proxy.",
        },
        scopes: {
    ...
    bindings: {
      ...
      reason: "Powód",
      effectiveAt: "Data wejścia w życie",
      expiresAt: "Data wygaśnięcia",
      accessStatusNormal: "Aktywny",
      accessStatusRestricted: "Ograniczony",
      accessStatusBanned: "Zablokowany",
