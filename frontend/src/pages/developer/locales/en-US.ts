const enUS = {
  ...
  pageMeta: {
    ...
    profile: {
      ...
      description:
        "Manage the current developer account profile and review applications you have authorized.",
    },
    console: {
  ...
  profile: {
    ...
    updateSuccess: "Developer profile updated",
    updateFailed: "Failed to update developer profile",
    status: {
      active: "Active",
      frozen: "Frozen",
      pending: "Pending",
  ...
  userAccess: {
    ...
    userAccessDetailTitle: "{{name}} Access Details",
    authorizedAppsCount: "{{count}} app(s)",
    authorizedAppsShortCount: "{{count}} app(s)",
    bannedApps: "Banned Apps",
    noBannedApps: "No banned apps",
    banReasonWithValue: "Ban reason: {{reason}}",
    deleteGroupConfirmTitle: "Delete group {{name}}?",
    filterAuthorizedApp: "Filter by authorized app",
    filterUserGroup: "Filter by user group",
    searchUserByEmail: "Search users by email",
    quickFilterAll: "All Users",
    quickFilterUngrouped: "Ungrouped",
    quickFilterRecent: "Recent",
    batchSetGroups: "Batch Set Groups",
    batchGroupMode: "Update Mode",
    batchGroupModeAppend: "Append",
    batchGroupModeReplace: "Replace",
    batchGroupModeRemove: "Remove",
    addSelectedToGroup: "Add to Group",
    banSelectedUsers: "Ban Selected Users",
    banSelectedUsersDescription:
      "Apply bans to {{count}} selected user(s) in the selected app(s).",
    selectedCurrentAppUsers: "{{count}} selected",
    selectApp: "Select App",
    selectGroup: "Select Group",
    currentAppAllUsersAllowed:
      "This app has no bound groups, so all signed-in users may log in. No specific user list is shown.",
    groupMembers: "Group Members",
    groupMembersHint:
      "Manage users in the selected group here. Add or remove members, and apply app-level bans to group users.",
    addGroupMembers: "Add Members",
    searchCandidateUser: "Search Addable Users",
    searchCandidateUserPlaceholder: "Search addable users by email",
    ...
    accessLogActions: {
      ...
      userGroupsUpdate: "Updated User Groups",
      userGroupsBatchUpdate: "Batch Updated User Groups",
      appBindingsUpdate: "Updated App Access",
      userBanCreate: "Banned User",
      userBanDelete: "Unbanned User",
      generic: "Access Rule Change",
    },
    accessLogSummaries: {
      groupCreate: 'Created group "{{name}}".',
      groupUpdate: 'Updated group "{{name}}".',
      groupDelete: 'Deleted group "{{name}}".',
      userGroupsUpdate: "Changed one user's groups. {{groupCount}} group(s) are now involved.",
      userGroupsBatchUpdate:
        'Changed {{userCount}} user(s) with "{{mode}}" mode across {{groupCount}} group(s).',
      appBindingsUpdate:
        "Updated the groups allowed to access the app. {{groupCount}} group(s) are currently bound.",
      userBanCreate: "Banned a user. Reason: {{reason}}.",
      userBanDelete: "Removed a user ban.",
      generic: "The system recorded an access-control change.",
    },
    batchSetGroupsDescription:
      "{{count}} user(s) selected. By default, selected groups will be appended while keeping existing groups.",
    selectAtLeastOneApp: "Please select at least one app",
