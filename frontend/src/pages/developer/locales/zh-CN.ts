const zhCN = {
  ...
  pageMeta: {
    ...
    profile: {
      title: "开发者个人信息",
      description: "独立维护当前开发者账号资料，并查看自己授权登录过的应用。",
    },
    console: {
      title: "开发者控制台",
  ...
  profile: {
    ...
    createdAt: "注册时间",
    loadFailed: "加载个人信息失败",
    updateSuccess: "开发者个人信息已更新",
    updateFailed: "开发者个人信息更新失败",
    status: {
      active: "正常",
      frozen: "冻结",
      pending: "待激活",
  ...
  userAccess: {
    ...
    userAccessDetailTitle: "{{name}}的访问详情",
    authorizedAppsCount: "共 {{count}} 个应用",
    authorizedAppsShortCount: "{{count}} 个应用",
    bannedApps: "封禁应用",
    noBannedApps: "暂无封禁应用",
    banReasonWithValue: "封禁原因：{{reason}}",
    deleteGroupConfirmTitle: "删除用户组 {{name}}？",
    filterAuthorizedApp: "筛选授权应用",
    filterUserGroup: "筛选用户组",
    searchUserByEmail: "通过邮箱搜索用户",
    quickFilterAll: "全部用户",
    quickFilterUngrouped: "未分组",
    quickFilterRecent: "最近授权",
    batchSetGroups: "批量设置用户组",
    batchGroupMode: "更新方式",
    batchGroupModeAppend: "追加到组",
    batchGroupModeReplace: "替换为组",
    batchGroupModeRemove: "移出组",
    addSelectedToGroup: "加入用户组",
    banSelectedUsers: "封禁选中用户",
    banSelectedUsersDescription: "将对已选 {{count}} 个用户执行所选应用下的封禁。",
    selectedCurrentAppUsers: "已选 {{count}} 个用户",
    selectApp: "选择应用",
    selectGroup: "选择用户组",
    currentAppAllUsersAllowed: "当前应用未绑定用户组，所有已登录用户均可登录，不显示具体用户名单。",
    groupMembers: "用户组成员",
    groupMembersHint: "这里单独管理所选用户组内的用户，可添加、移除成员，并对组内用户执行应用级封禁。",
    addGroupMembers: "添加组成员",
    searchCandidateUser: "搜索可添加用户",
    searchCandidateUserPlaceholder: "输入邮箱搜索可添加用户",
    removeFromGroup: "移出用户组",
    selectGroupFirst: "请先选择用户组",
    banStatus: "封禁状态",
    normalStatus: "正常",
    bannedStatus: "已封禁",
    logAction: "动作",
    ...
    accessLogActions: {
      ...
      groupUpdate: "更新用户组",
      groupDelete: "删除用户组",
      userGroupsUpdate: "更新用户分组",
      userGroupsBatchUpdate: "批量更新用户分组",
      appBindingsUpdate: "更新应用访问范围",
      userBanCreate: "封禁用户",
      userBanDelete: "解除用户封禁",
      generic: "访问控制变更",
    },
    accessLogSummaries: {
      groupCreate: "创建了用户组“{{name}}”。",
      groupUpdate: "更新了用户组“{{name}}”。",
      groupDelete: "删除了用户组“{{name}}”。",
      userGroupsUpdate: "调整了 1 个用户的分组，当前涉及 {{groupCount}} 个用户组。",
      userGroupsBatchUpdate: "按“{{mode}}”方式调整了 {{userCount}} 个用户，涉及 {{groupCount}} 个用户组。",
      appBindingsUpdate: "更新了应用允许访问的用户组范围，当前绑定 {{groupCount}} 个用户组。",
      userBanCreate: "已封禁用户，原因：{{reason}}。",
      userBanDelete: "已解除用户封禁。",
      generic: "系统记录了一次访问控制相关变更。",
    },
    batchSetGroupsDescription:
      "已选择 {{count}} 个用户，默认会在保留原分组的基础上追加所选用户组。",
