...
import { EmailSendLogsTable } from "./EmailSendLogsTable";

type EmailSendLogsPanelProps = {
  logs: EmailSendLog[];
...
export function EmailSendLogsPanel({
  logs,
  selectedLogIds,
  setSelectedLogIds,
  deletingLogs,
  ...
  const filteredLogs = useMemo(() => {
    ...
    return logs.filter((item) => item.target_email.toLowerCase().includes(normalizedKeyword));
  }, [keyword, logs]);
