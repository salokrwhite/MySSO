...
export const defaultSettings: SystemSettings = {
  ...
  captcha_IsShowHollowLine: false,
  captcha_IsShowNoiseDot: true,
  captcha_IsShowNoiseText: false,
  captcha_IsShowSlimeLine: true,
  captcha_IsShowSineLine: false,
  captcha_CaptchaLen: 6,
  captcha_ttl_seconds: 300,
  captcha_image_rate_limit_per_minute: 60,
  captcha_precheck_rate_limit_per_minute: 120,
  captcha_target_rate_limit_per_minute: 20,
