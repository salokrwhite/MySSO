  ...
  const menuItems =
    currentRole === "admin"
      ? [
          ...
          {
            key: "/admin/developer-access-logs",
            icon: <FileTextOutlined />,
            label: adminT("开发者访问日志"),
          },
          {
            key: "/admin/risk-logs",
      ...
      : currentRole === "developer"
        ? [
            ...
            {
              key: "/developer/user-access",
              icon: <UsergroupAddOutlined />,
              label: developerTranslationsReady
                ? t("menu.userAccess", { ns: "developer" })
                : developerFallback.menu.userAccess,
            },
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  children: [
                    ...
                    {
                      key: "/developer/docs/examples/csharp",
                      icon: csharpMenuIcon(),
                      label: "C#",
                    },
                    {
                    ...
                    {
                      key: "/developer/docs/examples/ruby",
                      icon: rubyMenuIcon(),
                      label: "Ruby",
                    },
                    {
                      key: "/developer/docs/examples/rust",
                      icon: rustMenuIcon(),
                      label: "Rust",
                    },
                  ],
